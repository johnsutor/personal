export const meta = {
  ...
  date: '2022-04-25T17:31:06+00:00',
}
...
![Creating a function](/diy-autograder-with-otter/create_function.png)
...
<video width="100%" autoplay loop muted style={{marginLeft: 'auto', marginRight: 'auto', display: 'block'}}>
  <source src="/diy-autograder-with-otter/autograder.mp4" type="video/mp4" />
</video>
