...
![Creating a function](/article3/create_function.PNG)
...
<video width="100%" autoplay="autoplay" loop="loop" style="margin-left: auto;margin-right: auto;display: block">
  <source src="/article3/autograder.mp4" type="video/mp4" />
</video>

# Closing Remarks
As you can see, it's pretty damn simple to implement a fully functional autograder with Google Cloud functions. If you have any suggestions for improvements or any questions in general, feel free to [reach out](mailto:john@sciteens.org?subject=Otter%20Autograder)!