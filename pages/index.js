...
export default function Home({ articles, projects }) {
  ...
  const [profiles, setProfiles] = useState([
    ...
    {
        name: "Medium",
        url: "https://medium.com/@johnsutor3",
        icon:
    ...
    {
        name: "Resume",
        url: "https://johnsutor.com/resume_js.pdf",
        icon: 
        `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <main className="h-full w-full">
          ...
          <div className="flex flex-col lg:flex-row w-full h-full">
            <div className="flex flex-col justify-center items-left -mt-12 lg:pt-0 lg:w-1/2 text-center lg:text-left h-screen ">
              ...
              <span class="flex w-full justify-center lg:justify-start items-center text-2xl font-bold mt-4 ">
                {
